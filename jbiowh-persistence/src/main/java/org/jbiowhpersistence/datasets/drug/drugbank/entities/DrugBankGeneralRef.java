...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DrugBankGeneralRef.findAll", query = "SELECT d FROM DrugBankGeneralRef d"),
    @NamedQuery(name = "DrugBankGeneralRef.findByWid", query = "SELECT d FROM DrugBankGeneralRef d WHERE d.wid = :wid"),
    @NamedQuery(name = "DrugBankGeneralRef.findByDrugBankWID", query = "SELECT d FROM DrugBankGeneralRef d WHERE d.drugBankWID = :drugBankWID")})
