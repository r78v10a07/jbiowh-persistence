 ...
 */
@Entity
@Table(name = "MIFParticipantPartIdentMeth")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "MIFParticipantPartIdentMeth.findAll", query = "SELECT m FROM MIFParticipantPartIdentMeth m"),
    @NamedQuery(name = "MIFParticipantPartIdentMeth.findByWid", query = "SELECT m FROM MIFParticipantPartIdentMeth m WHERE m.wid = :wid"),
    @NamedQuery(name = "MIFParticipantPartIdentMeth.findByMIFInteractionParticipantWID", query = "SELECT m FROM MIFParticipantPartIdentMeth m WHERE m.mIFInteractionParticipantWID = :mIFInteractionParticipantWID"),
    @NamedQuery(name = "MIFParticipantPartIdentMeth.findByShortLabel", query = "SELECT m FROM MIFParticipantPartIdentMeth m WHERE m.shortLabel = :shortLabel"),
    @NamedQuery(name = "MIFParticipantPartIdentMeth.findByFullName", query = "SELECT m FROM MIFParticipantPartIdentMeth m WHERE m.fullName = :fullName")})
public class MIFParticipantPartIdentMeth implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "mifParticipantPartIdentMeth")
    ...
    public MIFParticipantPartIdentMeth() {
    }

    public MIFParticipantPartIdentMeth(Long wid) {
        this.wid = wid;
    }

    public MIFParticipantPartIdentMeth(Long wid, long mIFInteractionParticipantWID) {
        this.wid = wid;
    ...
    public boolean equals(Object obj) {
        ...
        final MIFParticipantPartIdentMeth other = (MIFParticipantPartIdentMeth) obj;
    ...
    public String toString() {
        return "MIFParticipantPartIdentMeth{" + "wid=" + wid + ", mIFInteractionParticipantWID=" + mIFInteractionParticipantWID + ", shortLabel=" + shortLabel + ", fullName=" + fullName + '}';
    }
}
