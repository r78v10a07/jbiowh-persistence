...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DrugBankGroup.findAll", query = "SELECT d FROM DrugBankGroup d"),
    @NamedQuery(name = "DrugBankGroup.findByWid", query = "SELECT d FROM DrugBankGroup d WHERE d.wid = :wid"),
    @NamedQuery(name = "DrugBankGroup.findByDrugBankWID", query = "SELECT d FROM DrugBankGroup d WHERE d.drugBankWID = :drugBankWID"),
    @NamedQuery(name = "DrugBankGroup.findByGroupName", query = "SELECT d FROM DrugBankGroup d WHERE d.groupName = :groupName")})
public class DrugBankGroup implements Serializable {
    ...
    public DrugBankGroup(Long wid) {
        this.wid = wid;
    }

    public DrugBankGroup(Long wid, long drugBankWID) {
        this.wid = wid;
    ...
    public String toString() {
        return "DrugBankGroup{" + "wid=" + wid + ", drugBankWID=" + drugBankWID + ", groupName=" + groupName + '}';
    }
}
