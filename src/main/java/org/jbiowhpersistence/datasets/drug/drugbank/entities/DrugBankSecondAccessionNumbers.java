...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DrugBankSecondAccessionNumbers.findAll", query = "SELECT d FROM DrugBankSecondAccessionNumbers d"),
    @NamedQuery(name = "DrugBankSecondAccessionNumbers.findByWid", query = "SELECT d FROM DrugBankSecondAccessionNumbers d WHERE d.wid = :wid"),
    @NamedQuery(name = "DrugBankSecondAccessionNumbers.findByDrugBankWID", query = "SELECT d FROM DrugBankSecondAccessionNumbers d WHERE d.drugBankWID = :drugBankWID"),
    @NamedQuery(name = "DrugBankSecondAccessionNumbers.findByAccessionNumber", query = "SELECT d FROM DrugBankSecondAccessionNumbers d WHERE d.accessionNumber = :accessionNumber")})
public class DrugBankSecondAccessionNumbers implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final DrugBankSecondAccessionNumbers other = (DrugBankSecondAccessionNumbers) obj;
