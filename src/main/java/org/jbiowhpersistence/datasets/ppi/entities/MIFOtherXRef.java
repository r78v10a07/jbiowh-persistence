 ...
 */
@Entity
@Table(name = "MIFOtherXRef")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "MIFOtherXRef.findAll", query = "SELECT m FROM MIFOtherXRef m"),
    @NamedQuery(name = "MIFOtherXRef.findByWid", query = "SELECT m FROM MIFOtherXRef m WHERE m.wid = :wid"),
    @NamedQuery(name = "MIFOtherXRef.findByMIFOtherWID", query = "SELECT m FROM MIFOtherXRef m WHERE m.mIFOtherWID = :mIFOtherWID"),
    @NamedQuery(name = "MIFOtherXRef.findByDb", query = "SELECT m FROM MIFOtherXRef m WHERE m.db = :db"),
    @NamedQuery(name = "MIFOtherXRef.findByDBAc", query = "SELECT m FROM MIFOtherXRef m WHERE m.dBAc = :dBAc"),
    @NamedQuery(name = "MIFOtherXRef.findById", query = "SELECT m FROM MIFOtherXRef m WHERE m.id = :id"),
    @NamedQuery(name = "MIFOtherXRef.findBySecondary", query = "SELECT m FROM MIFOtherXRef m WHERE m.secondary = :secondary"),
    @NamedQuery(name = "MIFOtherXRef.findByVersion", query = "SELECT m FROM MIFOtherXRef m WHERE m.version = :version"),
    @NamedQuery(name = "MIFOtherXRef.findByRefType", query = "SELECT m FROM MIFOtherXRef m WHERE m.refType = :refType"),
    @NamedQuery(name = "MIFOtherXRef.findByRefTypeAc", query = "SELECT m FROM MIFOtherXRef m WHERE m.refTypeAc = :refTypeAc"),
    @NamedQuery(name = "MIFOtherXRef.findByPrimaryRef", query = "SELECT m FROM MIFOtherXRef m WHERE m.primaryRef = :primaryRef"),
    @NamedQuery(name = "MIFOtherXRef.findByDataSetWID", query = "SELECT m FROM MIFOtherXRef m WHERE m.dataSetWID = :dataSetWID")})
public class MIFOtherXRef implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "mifOtherXRef")
    ...
    public MIFOtherXRef(Long wid) {
        this.wid = wid;
    }

    public MIFOtherXRef(Long wid, long mIFOtherWID, long dataSetWID) {
        this.wid = wid;
    ...
    public boolean equals(Object obj) {
        ...
        final MIFOtherXRef other = (MIFOtherXRef) obj;
    ...
    public String toString() {
        return "MIFOtherXRef{" + "wid=" + wid + ", mIFOtherWID=" + mIFOtherWID + ", db=" + db + ", dBAc=" + dBAc + ", id=" + id + ", secondary=" + secondary + ", version=" + version + ", refType=" + refType + ", refTypeAc=" + refTypeAc + ", primaryRef=" + primaryRef + ", dataSetWID=" + dataSetWID + '}';
    }
}
