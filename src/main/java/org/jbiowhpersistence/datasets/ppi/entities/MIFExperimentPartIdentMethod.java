 ...
 */
@Entity
@Table(name = "MIFExperimentPartIdentMethod")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "MIFExperimentPartIdentMethod.findAll", query = "SELECT m FROM MIFExperimentPartIdentMethod m"),
    @NamedQuery(name = "MIFExperimentPartIdentMethod.findByWid", query = "SELECT m FROM MIFExperimentPartIdentMethod m WHERE m.wid = :wid"),
    @NamedQuery(name = "MIFExperimentPartIdentMethod.findByMIFEntryExperimentWID", query = "SELECT m FROM MIFExperimentPartIdentMethod m WHERE m.mIFEntryExperimentWID = :mIFEntryExperimentWID"),
    @NamedQuery(name = "MIFExperimentPartIdentMethod.findByShortLabel", query = "SELECT m FROM MIFExperimentPartIdentMethod m WHERE m.shortLabel = :shortLabel"),
    @NamedQuery(name = "MIFExperimentPartIdentMethod.findByFullName", query = "SELECT m FROM MIFExperimentPartIdentMethod m WHERE m.fullName = :fullName")})
public class MIFExperimentPartIdentMethod implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "mifExperimentPartIdentMethod")
    ...
    public MIFExperimentPartIdentMethod() {
    }

    public MIFExperimentPartIdentMethod(Long wid) {
        this.wid = wid;
    }

    public MIFExperimentPartIdentMethod(Long wid, long mIFEntryExperimentWID) {
        this.wid = wid;
    ...
    public boolean equals(Object obj) {
        ...
        final MIFExperimentPartIdentMethod other = (MIFExperimentPartIdentMethod) obj;
    ...
    public String toString() {
        return "MIFExperimentPartIdentMethod{" + "wid=" + wid + ", mIFEntryExperimentWID=" + mIFEntryExperimentWID + ", shortLabel=" + shortLabel + ", fullName=" + fullName + '}';
    }
}
