 ...
 */
@Entity
@Table(name = "MIFFeatureFeatDetMeth")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "MIFFeatureFeatDetMeth.findAll", query = "SELECT m FROM MIFFeatureFeatDetMeth m"),
    @NamedQuery(name = "MIFFeatureFeatDetMeth.findByWid", query = "SELECT m FROM MIFFeatureFeatDetMeth m WHERE m.wid = :wid"),
    @NamedQuery(name = "MIFFeatureFeatDetMeth.findByMIFParticipantFeatureWID", query = "SELECT m FROM MIFFeatureFeatDetMeth m WHERE m.mIFParticipantFeatureWID = :mIFParticipantFeatureWID"),
    @NamedQuery(name = "MIFFeatureFeatDetMeth.findByShortLabel", query = "SELECT m FROM MIFFeatureFeatDetMeth m WHERE m.shortLabel = :shortLabel"),
    @NamedQuery(name = "MIFFeatureFeatDetMeth.findByFullName", query = "SELECT m FROM MIFFeatureFeatDetMeth m WHERE m.fullName = :fullName")})
public class MIFFeatureFeatDetMeth implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "mifFeatureFeatDetMeth")
    ...
    public MIFFeatureFeatDetMeth() {
    }

    public MIFFeatureFeatDetMeth(Long wid) {
        this.wid = wid;
    }

    public MIFFeatureFeatDetMeth(Long wid, long mIFParticipantFeatureWID) {
        this.wid = wid;
    ...
    public boolean equals(Object obj) {
        ...
        final MIFFeatureFeatDetMeth other = (MIFFeatureFeatDetMeth) obj;
    ...
    public String toString() {
        return "MIFFeatureFeatDetMeth{" + "wid=" + wid + ", mIFParticipantFeatureWID=" + mIFParticipantFeatureWID + ", shortLabel=" + shortLabel + ", fullName=" + fullName + '}';
    }
}
