 ...
 */
@Entity
@Table(name = "MIFOtherXRefUniprot")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "MIFOtherXRefUniprot.findAll", query = "SELECT m FROM MIFOtherXRefUniprot m"),
    @NamedQuery(name = "MIFOtherXRefUniprot.findByWid", query = "SELECT m FROM MIFOtherXRefUniprot m WHERE m.wid = :wid"),
    @NamedQuery(name = "MIFOtherXRefUniprot.findByMIFOtherWID", query = "SELECT m FROM MIFOtherXRefUniprot m WHERE m.mIFOtherWID = :mIFOtherWID"),
    @NamedQuery(name = "MIFOtherXRefUniprot.findByDb", query = "SELECT m FROM MIFOtherXRefUniprot m WHERE m.db = :db"),
    @NamedQuery(name = "MIFOtherXRefUniprot.findByDBAc", query = "SELECT m FROM MIFOtherXRefUniprot m WHERE m.dBAc = :dBAc"),
    @NamedQuery(name = "MIFOtherXRefUniprot.findById", query = "SELECT m FROM MIFOtherXRefUniprot m WHERE m.id = :id"),
    @NamedQuery(name = "MIFOtherXRefUniprot.findBySecondary", query = "SELECT m FROM MIFOtherXRefUniprot m WHERE m.secondary = :secondary"),
    @NamedQuery(name = "MIFOtherXRefUniprot.findByVersion", query = "SELECT m FROM MIFOtherXRefUniprot m WHERE m.version = :version"),
    @NamedQuery(name = "MIFOtherXRefUniprot.findByRefType", query = "SELECT m FROM MIFOtherXRefUniprot m WHERE m.refType = :refType"),
    @NamedQuery(name = "MIFOtherXRefUniprot.findByRefTypeAc", query = "SELECT m FROM MIFOtherXRefUniprot m WHERE m.refTypeAc = :refTypeAc"),
    @NamedQuery(name = "MIFOtherXRefUniprot.findByPrimaryRef", query = "SELECT m FROM MIFOtherXRefUniprot m WHERE m.primaryRef = :primaryRef"),
    @NamedQuery(name = "MIFOtherXRefUniprot.findByDataSetWID", query = "SELECT m FROM MIFOtherXRefUniprot m WHERE m.dataSetWID = :dataSetWID")})
public class MIFOtherXRefUniprot implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "mifOtherXRefUniprot")
    ...
    public MIFOtherXRefUniprot() {
    }

    public MIFOtherXRefUniprot(Long wid) {
        this.wid = wid;
    }

    public MIFOtherXRefUniprot(Long wid, long mIFOtherWID, long dataSetWID) {
        this.wid = wid;
    ...
    public boolean equals(Object obj) {
        ...
        final MIFOtherXRefUniprot other = (MIFOtherXRefUniprot) obj;
    ...
    public String toString() {
        return "MIFOtherXRefUniprot{" + "wid=" + wid + ", mIFOtherWID=" + mIFOtherWID + ", db=" + db + ", dBAc=" + dBAc + ", id=" + id + ", secondary=" + secondary + ", version=" + version + ", refType=" + refType + ", refTypeAc=" + refTypeAc + ", primaryRef=" + primaryRef + ", dataSetWID=" + dataSetWID + '}';
    }
}
