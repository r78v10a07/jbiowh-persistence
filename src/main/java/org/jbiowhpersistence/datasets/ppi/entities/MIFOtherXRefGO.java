 ...
 */
@Entity
@Table(name = "MIFOtherXRefGO")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "MIFOtherXRefGO.findAll", query = "SELECT m FROM MIFOtherXRefGO m"),
    @NamedQuery(name = "MIFOtherXRefGO.findByWid", query = "SELECT m FROM MIFOtherXRefGO m WHERE m.wid = :wid"),
    @NamedQuery(name = "MIFOtherXRefGO.findByMIFOtherWID", query = "SELECT m FROM MIFOtherXRefGO m WHERE m.mIFOtherWID = :mIFOtherWID"),
    @NamedQuery(name = "MIFOtherXRefGO.findByDb", query = "SELECT m FROM MIFOtherXRefGO m WHERE m.db = :db"),
    @NamedQuery(name = "MIFOtherXRefGO.findByDBAc", query = "SELECT m FROM MIFOtherXRefGO m WHERE m.dBAc = :dBAc"),
    @NamedQuery(name = "MIFOtherXRefGO.findById", query = "SELECT m FROM MIFOtherXRefGO m WHERE m.id = :id"),
    @NamedQuery(name = "MIFOtherXRefGO.findBySecondary", query = "SELECT m FROM MIFOtherXRefGO m WHERE m.secondary = :secondary"),
    @NamedQuery(name = "MIFOtherXRefGO.findByVersion", query = "SELECT m FROM MIFOtherXRefGO m WHERE m.version = :version"),
    @NamedQuery(name = "MIFOtherXRefGO.findByRefType", query = "SELECT m FROM MIFOtherXRefGO m WHERE m.refType = :refType"),
    @NamedQuery(name = "MIFOtherXRefGO.findByRefTypeAc", query = "SELECT m FROM MIFOtherXRefGO m WHERE m.refTypeAc = :refTypeAc"),
    @NamedQuery(name = "MIFOtherXRefGO.findByPrimaryRef", query = "SELECT m FROM MIFOtherXRefGO m WHERE m.primaryRef = :primaryRef"),
    @NamedQuery(name = "MIFOtherXRefGO.findByDataSetWID", query = "SELECT m FROM MIFOtherXRefGO m WHERE m.dataSetWID = :dataSetWID")})
public class MIFOtherXRefGO implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "mifOtherXRefGO")
    ...
    public MIFOtherXRefGO() {
    }

    public MIFOtherXRefGO(Long wid) {
        this.wid = wid;
    }

    public MIFOtherXRefGO(Long wid, long mIFOtherWID, long dataSetWID) {
        this.wid = wid;
    ...
    public boolean equals(Object obj) {
        ...
        final MIFOtherXRefGO other = (MIFOtherXRefGO) obj;
    ...
    public String toString() {
        return "MIFOtherXRefGO{" + "wid=" + wid + ", mIFOtherWID=" + mIFOtherWID + ", db=" + db + ", dBAc=" + dBAc + ", id=" + id + ", secondary=" + secondary + ", version=" + version + ", refType=" + refType + ", refTypeAc=" + refTypeAc + ", primaryRef=" + primaryRef + ", dataSetWID=" + dataSetWID + '}';
    }
}
